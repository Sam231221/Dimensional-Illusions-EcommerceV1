...
#Graphics CRUD    
    ...
    path('account/dashboard/addgraphics/',views.addgraphics,name="addgraphics"),
    path('account/dashboard/updategraphics/<str:pk>/update',views.updategraphics,name="updategraphics"),
    path('account/dashboard/graphics/<str:pk>/delete/',views.deletegraphics,name="deletegraphics"),
