...
class VfxCategory(models.Model):
...
class FreeVfxProduct(models.Model):
	name=models.CharField(null=True,max_length=100)
	category=models.ForeignKey(VfxCategory,on_delete=models.SET_NULL
...
class PaidVfxProduct(models.Model):
	name=models.CharField(null=True
						,verbose_name='Product name'
					   ,max_length=100)
	publisher= models.ForeignKey(Profile,on_delete=models.CASCADE,null=True)    
	category=models.ForeignKey(VfxCategory,on_delete=models.SET_NULL
							   ,verbose_name='Vfx Category'
							   ,null=True) 
...
class OrderPaidVfxProduct(models.Model):  #make more orderitem
	profile = models.ForeignKey(Profile, on_delete=models.CASCADE, blank=True, null=True)     
	product = models.ForeignKey(PaidVfxProduct, on_delete=models.SET_NULL, blank=True, null=True)  #it's gonna give you what you actually define in  def__str___.....return self.name
